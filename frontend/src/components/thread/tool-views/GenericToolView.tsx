...
export function GenericToolView({
  ...
  return (
      ...
      <CardHeader className="h-14 bg-muted/50 border-b p-2 px-4 space-y-2">
      ...
      <div className="px-4 py-2 h-10 bg-muted/20 border-t border-border flex justify-between items-center gap-4">
